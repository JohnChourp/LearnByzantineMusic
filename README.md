...
- Η εφαρμογή χρησιμοποιεί πλέον Room index + Paging3 και οι λίστες πρέπει να εμφανίζονται άμεσα, ακόμη και όταν το indexing συνεχίζεται στο παρασκήνιο.
- Αν υπάρχει πρώτη καθυστέρηση μετά από αλλαγές σε πολλά αρχεία, περίμενε να ολοκληρωθεί το reindex (linear progress στην κορυφή).
