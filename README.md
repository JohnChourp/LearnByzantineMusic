...
Η λειτουργία `Συνθέτης` έχει καταργηθεί πλήρως και αντικαταστάθηκε από νέα σελίδα `8 Ήχοι`, όπου ο χρήστης βλέπει κλίμακες, φθόγγους και διαστήματα (σε μόρια) για άνοδο και κάθοδο.
