...
Η λειτουργία `Συνθέτης` έχει καταργηθεί πλήρως και αντικαταστάθηκε από νέα σελίδα `8 Ήχοι`, όπου ο χρήστης βλέπει κλίμακες και διαστήματα (σε μόρια) στην άνοδο μέσα από οπτικό διάγραμμα τύπου «σκάλα».
