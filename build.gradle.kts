...
buildscript {
    configurations.matching { it.name == "classpath" }.all {
        ...
        resolutionStrategy.force("com.google.protobuf:protobuf-java:4.36.1")
        resolutionStrategy.force("com.google.protobuf:protobuf-javalite:4.36.1")
        resolutionStrategy.force("com.google.protobuf:protobuf-kotlin:4.36.1")
        resolutionStrategy.force("com.google.protobuf:protobuf-kotlin-lite:4.36.1")
