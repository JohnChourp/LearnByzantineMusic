...
buildscript {
    configurations.matching { it.name == "classpath" }.all {
        ...
        resolutionStrategy.force("com.google.protobuf:protobuf-java:4.36.0")
        resolutionStrategy.force("com.google.protobuf:protobuf-javalite:4.36.0")
        resolutionStrategy.force("com.google.protobuf:protobuf-kotlin:4.36.0")
        resolutionStrategy.force("com.google.protobuf:protobuf-kotlin-lite:4.36.0")
        ...
        resolutionStrategy.force("io.netty:netty-codec:4.2.17.Final")
        // Force patched netty-codec-compression due AGP/UTP transitive dependency vulnerability.
        resolutionStrategy.force("io.netty:netty-codec-compression:4.2.17.Final")
        ...
        resolutionStrategy.force("io.netty:netty-codec-http2:4.2.17.Final")
        // Force patched netty-handler due AGP/UTP transitive dependency vulnerability.
        resolutionStrategy.force("io.netty:netty-handler:4.2.17.Final")
        // Force patched netty-handler-proxy due AGP/UTP transitive dependency vulnerability.
        resolutionStrategy.force("io.netty:netty-handler-proxy:4.2.17.Final")
