...
buildscript {
    configurations.matching { it.name == "classpath" }.all {
        ...
        resolutionStrategy.force("io.netty:netty-codec:4.1.133.Final")
        ...
        resolutionStrategy.force("io.netty:netty-codec-http2:4.1.133.Final")
        // Force patched netty-handler due AGP/UTP transitive dependency vulnerability.
        resolutionStrategy.force("io.netty:netty-handler:4.1.133.Final")
