...
buildscript {
    configurations.matching { it.name == "classpath" }.all {
        ...
        resolutionStrategy.force("com.google.protobuf:protobuf-java:4.36.2")
        resolutionStrategy.force("com.google.protobuf:protobuf-javalite:4.36.2")
        resolutionStrategy.force("com.google.protobuf:protobuf-kotlin:4.36.2")
        resolutionStrategy.force("com.google.protobuf:protobuf-kotlin-lite:4.36.2")
        ...
        resolutionStrategy.force("org.bouncycastle:bcpkix-jdk18on:1.86")
        resolutionStrategy.force("org.bouncycastle:bcprov-jdk18on:1.86")
        resolutionStrategy.force("org.bouncycastle:bcutil-jdk18on:1.86")
    }
    dependencies {
